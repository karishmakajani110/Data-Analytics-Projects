...
- Used temporary tables and views to store intermediate results for reuse and future visualization
- Applied window functions (PARTITION BY) for population-based and comparative analysis
